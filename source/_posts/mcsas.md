 ...
 * @LastEditTime: 2026-03-06 14:28:22
 * @FilePath: \undefinedd:\web\pages\source\_posts\mcsas.md
-->
---
title: MC服务端无人自动休眠核心
date: 2025-01-15 18:58:07
...
> [!WARNING]
>
> 直接终止本程序进程会导致服务器无法正常终止, 要关闭请输入stop 命令
> 中文需要使用unicode编码
>
## 参数说明
| 参数            | 类型      | 默认值                               | 说明                                     |
...
| MOTD          | String  | `§a服务器正在休眠中...§r\n§e点击进入以启动服务器§r` | 休眠状态下显示的motd (中文需要使用unicode编码)         |
| StartMessage  | String  | `§a服务器正在启动中，请稍候...§r`             | 玩家尝试加入后给出的提示 (中文需要使用unicode编码)         |
...
```
## 下载
- [MCSAS-1.3.0-SNAPSHOT.jar](MCSAS-1.3.0-SNAPSHOT.jar)
- [releases](https://github.com/Guailoudou/MCServerAutoSleep/releases)