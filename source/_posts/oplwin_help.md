...
组网而有时候官方节点会故障，表现为启动后不出现ip信息，可以搜索`easytier公共节点`寻找有效节点，填入节点中使用 (尽量选择可中转的节点，下面有个我搭的，可以用)

注意节点应该填写为 tcp://ip:端口的形式 如： `tcp://public.easytier.top:11010` `tcp://118.193.34.69:11010` <- 这个节点为我个人提供，香港服务器，能用，但是延迟不一定理想，且带宽不高
